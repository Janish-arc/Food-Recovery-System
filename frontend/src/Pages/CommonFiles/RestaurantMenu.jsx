...
import { CreateFood, DeleteFood, GetMenuOfRestaurant, ToggleFoodAvailability} from "../../Redux/FoodSlice";
...
export const RestaurantMenu = () => {
    ...
    const {resFood, loading, success} = useSelector((state) => state.food);
